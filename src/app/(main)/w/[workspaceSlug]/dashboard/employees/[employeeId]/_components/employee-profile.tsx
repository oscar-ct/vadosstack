        ...
        <header className="border-b bg-card px-4 py-5 md:px-6">
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                {canManageAccess && employee.dashboardAccess ? (
                  <div className="mt-2 flex flex-wrap items-center gap-1.5">
                    <Badge variant={employee.dashboardAccess.status === "Active" ? "secondary" : "outline"}>
                      Dashboard: {employee.dashboardAccess.status}
                    </Badge>
                    {employee.dashboardAccess.roleName ? (
                      <Badge variant="outline">{employee.dashboardAccess.roleName}</Badge>
                    ) : null}
                    {employee.dashboardAccess.isCustomRole ? <Badge variant="outline">Custom role</Badge> : null}
                    <Link href="/dashboard/roles" className="font-medium text-xs underline-offset-4 hover:underline">
                      Manage access
                    </Link>
                  </div>
                ) : null}
            ...
            {canManage ? (
              ...
              <PermissionDisabledButton size="sm" reason="Your role can view employee profiles but cannot edit them.">
                <Pencil />
                Edit profile
