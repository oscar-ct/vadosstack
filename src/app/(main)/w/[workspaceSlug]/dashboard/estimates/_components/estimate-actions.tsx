...
export function EstimateActions({
  ...
  canManageDocumentMessage?: boolean;
  canSend?: boolean;
  compact?: boolean;
  companyName: string;
  ...
  return (
    <div className="grid gap-2 print:hidden">
      <div className="flex flex-wrap items-center justify-end gap-2">
        {canSend && estimateId && (!compact || primaryEmail) ? (
          <Button
            type="button"
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            {canSend && estimateId && (!primaryEmail || !compact) ? (
              <DropdownMenuItem
            ...
            {canManageDocumentMessage ? (
              <DropdownMenuItem onSelect={() => setEstimateNoteOpen(true)}>
                <FilePenLine />
                Estimate note
              </DropdownMenuItem>
            ) : null}
            {deleteAction ? <DropdownMenuSeparator /> : null}
            {deleteAction ? (
