...
const sections = [
  {
    ...
    body: [
      ...
      "When you use the product, you may enter business information such as customers, jobs, estimates, invoices, tasks, calendar items, service templates, employees, time entries, notes, phone numbers, addresses, and uploaded company assets.",
      "We may collect technical information such as device type, browser, IP address, pages visited, timestamps, session records, rate-limit records, and error details to help keep the service secure and reliable.",
      "We use necessary cookies and similar storage to keep you signed in, remember basic preferences, protect accounts, and operate the service. We do not use advertising cookies.",
    ],
  },
  {
    title: "How We Use Information",
    body: [
      "We use your information to provide the dashboard, sign-in, customer management, job tracking, task scheduling, estimating, invoicing, email delivery, employee time tracking, support, security, and account administration features.",
  ...
  },
  {
    ...
    body: [
      ...
      "If you choose to connect Gmail for estimate or invoice sending, we request the Gmail send-only permission, https://www.googleapis.com/auth/gmail.send. We use that permission only to send estimate or invoice emails that you initiate from VadosStack.",
      "VadosStack does not use Gmail access to read, search, download, modify, delete, or monitor your mailbox. We do not use Gmail data for advertising, user profiling, model training, or any purpose unrelated to sending estimate or invoice emails you request.",
      "To keep the feature connected, we store the connected Gmail address, Google account identifier, granted scopes, and an encrypted Google refresh token associated with your VadosStack account. This token is used to request temporary Gmail access tokens for sending estimate or invoice emails. We do not store your Google password.",
      "When an email is sent, we may keep an email delivery record with information such as document type, document number, recipient, sender, subject, status, timestamp, and error details so you can review delivery history and troubleshoot failures.",
      "You can revoke VadosStack's Google access at any time from your Google Account permissions. After access is revoked, Gmail estimate or invoice sending may stop working until you reconnect Gmail.",
